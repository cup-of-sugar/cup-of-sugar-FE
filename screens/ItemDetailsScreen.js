  ...
  return (
    <ScrollView style={styles.container} contentContainerStyle={styles.contentContainer}>
      ...
      <View style={styles.infoContainer}>
        ...
        <Text style={styles.itemInfo}>{item.quantity} {item.measurement} available</Text>
        ...
        <Text style={styles.itemInfo}>{item.description || 'No description yet!'}</Text>
      </View>
      <TouchableOpacity style={styles.borrowButton}><Text style={styles.borrowButtonText}>Borrow this Item</Text></TouchableOpacity>
    </ScrollView>
  );
}
